...
let PgCategoryComponent = class PgCategoryComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PgCategoryhomeComponent = class PgCategoryhomeComponent {
    constructor() {
        this.isVisible = true;
    }
    ngOnInit() {
...
let PgHeaderComponent = class PgHeaderComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PgHomeComponent = class PgHomeComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PgLoginComponent = class PgLoginComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PgMenuComponent = class PgMenuComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PgPageheaderComponent = class PgPageheaderComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PgProductcardComponent = class PgProductcardComponent {
    constructor() {
...
let PgProductcatalogueComponent = class PgProductcatalogueComponent {
    constructor() {
        this.products = [
...
let PgTreeLangComponent = class PgTreeLangComponent {
    constructor() {
...
let PgTreeComponent = class PgTreeComponent {
    constructor() {
...
let PostsComponent = class PostsComponent {
    ...
    createPost(input) {
        ...
        input.value = "";
        this.service.create(input).subscribe(newPost => {
            post["id"] = newPost.id;
            console.log(newPost);
        }, (error) => {
...
/* harmony import */ var _angular_redux_store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular-redux/store */ "./node_modules/@angular-redux/store/fesm2015/angular-redux-store.js");
...
let DataService = class DataService {
    ...
    getAll_Post() {
        ...
        return this.http.get(this.url)
            .subscribe(posts => {
            this.ngRedux.dispatch({ type: _actions__WEBPACK_IMPORTED_MODULE_9__["GET_POSTS"], payload: posts.json() });
    ...
    getAll() {
        return this.http.get(this.url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response.json()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    }
    getAllUsers() {
...
let PostService = class PostService extends _data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"] {
